...
The shutdown service is built-in to Trapperkeeper and, like the [configuration service](Configuration-Service), is always loaded.  It has two main responsibilities:
